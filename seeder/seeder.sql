...
CREATE DATABASE
IF NOT EXISTS `gezondheidsmeter`;
...
ADD CONSTRAINT `fk_Questions_Sections` FOREIGN KEY
(`section_id`) REFERENCES `gezondheidsmeter`.`Sections`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION;
...
ADD CONSTRAINT `fk_Results_Awnsers` FOREIGN KEY
(`awnser_id`) REFERENCES `gezondheidsmeter`.`Awnsers`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION,
ADD CONSTRAINT `fk_Results_Questions` FOREIGN KEY
(`question_id`) REFERENCES `gezondheidsmeter`.`Questions`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION,
ADD CONSTRAINT `fk_Results_Users` FOREIGN KEY
(`user_id`) REFERENCES `gezondheidsmeter`.`Users`
(`id`) ON
DELETE CASCADE ON
UPDATE NO ACTION;
...
-- Voegt de antwoorden toe aan de database
INSERT INTO `
gezondheidsmeter`.`Awnsers
`
(`awnsers`, `points`, `created_at`) VALUES
("Slecht", 0, current_timestamp
());
INSERT INTO `
gezondheidsmeter`.`Awnsers
`
(`awnsers`, `points`, `created_at`) VALUES
("Kan beter", 1, current_timestamp
());
INSERT INTO `
gezondheidsmeter`.`Awnsers
`
(`awnsers`, `points`, `created_at`) VALUES
("Oke", 2, current_timestamp
());
INSERT INTO `
gezondheidsmeter`.`Awnsers
`
(`awnsers`, `points`, `created_at`) VALUES
("Goed", 3, current_timestamp
());