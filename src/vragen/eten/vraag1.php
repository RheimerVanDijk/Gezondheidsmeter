...
<div class="Hoofdtitel">
  ...
  <label for="s5gfa">Groente, fruit en aardappelen</label><br>
  <input type="checkbox" id="s5denP" name="DenP" value="1">
  <label for="s5denP">Vlees, vis, kaas, eieren en peulvruchten</label><br>
  <input type="checkbox" id="s5vetten" name="Vetten" value="1">
